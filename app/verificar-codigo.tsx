...
import { View, Text, ScrollView, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard, Platform } from "react-native";
              ...
              <View className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                {codigoEnviado ? (
                  <>
                    ...
                    <Button onPress={verificarCodigo} disabled={isLoading}>
                  ...
                  <Button onPress={solicitarCodigo} disabled={isLoading}>
                    <View className="flex-row items-center">
                      ...
                      <Text className="text-white font-semibold ml-2">{isLoading ? "Enviando..." : "Obtener Código"}</Text>
                    </View>
                  </Button>
                )}
              </View>
