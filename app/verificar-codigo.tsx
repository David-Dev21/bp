...
export default function SolicitarCodigoScreen() {
  ...
  const { codigo, codigoEnviado, isLoading, celular, solicitarCodigo, verificarCodigo, setCodigo } = useVerificacionCodigo();
                ...
                <View className="mb-8">
                  <OtpInput
                    ...
                    theme={{
                      ...
                      focusStickStyle: { backgroundColor: tema.primary },
                      focusedPinCodeContainerStyle: { borderColor: tema.primary },
                    }}
                  />
                </View>
